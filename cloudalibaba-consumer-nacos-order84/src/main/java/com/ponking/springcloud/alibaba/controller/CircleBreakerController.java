...
import com.ponking.springcloud.alibaba.service.PaymentService;
...
//    @SentinelResource(value = "fallback", fallback = "handlerFallback", blockHandler = "blockHandler")
    ...
    @SentinelResource(value = "paymentSQLFallback", fallback = "handlerFallback", blockHandler = "blockHandler",
            exceptionsToIgnore = {IllegalArgumentException.class})
